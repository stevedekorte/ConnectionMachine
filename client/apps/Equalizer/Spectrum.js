...
Spectrum = {
	...
	timeStep: function () {
		...
		for (var i = 0; i < this._analyserNode.frequencyBinCount; i++) {
			bins.push(freqByteData[i] * (this.gain + this.gainTweak))
		}
	...
	initAudio: function () {
		...
		navigator.mediaDevices.getUserMedia({ audio: true }, function (s) { Spectrum.gotStream(s) }, function (e) {
