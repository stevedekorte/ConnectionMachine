...
class HT1632C(object):
    def __init__(self, num_panels, rotation):
        libPath = os.path.abspath(
            ...
            "/../libht1632c-py.so")
        libPath = os.path.abspath("./libht1632c-py.so")
        ...
        self.lib.ht1632c_putchar.argtypes = [
            c_int, c_int, c_char, c_void_p, c_byte, c_byte
        ]
        self.lib.ht1632c_putchar.restype = c_int
        self.lib.ht1632c_putchar_metric.argtypes = [
            c_int, c_int, c_char, c_void_p, c_byte, c_byte
        ]
        self.lib.ht1632c_putchar_metric.restype = c_int
        self.lib.ht1632c_putstr.argtypes = [
            c_int, c_int, c_char_p, c_void_p, c_byte, c_byte
        ]
        self.lib.ht1632c_putstr.restype = c_int
        self.lib.ht1632c_putstr_metric.argtypes = [
            c_int, c_int, c_char_p, c_void_p, c_byte, c_byte
        ]
    ...
    def putstr_metric(self, x, y, s, font, color, bg):
        return self.lib.ht1632c_putstr_metric(x, y, encodeStr(s), font, color,
                                              bg)
